...
class run_sim:
    ...
    def train_loop_v0(self
        ...
        N_INI.run_W_DENSE_initialization_loop_PURE_STDP(sess_IN=sess
        ...
        val_spike_files_l,val_s_agg_files_l = N1.generate_validation_or_test_spike_data_PURE_STDP(sess_IN=sess
        ...
        for TRAIN_FULL_DATA_ITER in range(0,NUM_OF_TRAIN_CYLES_ON_DATASET_IN):
            ...
            for ITER_OVER_BLOCKS_OF_BATCHS in range(0,NUM_BLOCKS_OF_BATCHES_IN_FULL_DATASET):
                ...
                train_spikes_files_l, train_s_agg_files_l = N1.train_on_set_number_of_batches_PURE_STDP(sess_IN=sess
                                                                           , saver_object_IN=smart_saver
            ...
            val_acc = N1.evaluate_output_layer_on_FULL_validation_or_test_s_agg_data(
                                                                ...
                                                                # , root_save_name_IN='VAL_EVAL_'+ str(SAVE_VER_IN)+'_DATASET_ITER_'+str(TRAIN_FULL_DATA_ITER)
                                                                )
