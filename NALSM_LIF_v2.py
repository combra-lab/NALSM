...
class CUBA_LIF_network:
    ...
    def reinitialize_network_parameters_v2(self, tau_v_IN, tau_u_IN, v_thrsh_IN, b_IN, v_IN, w_IN, r_IN, w_mask_IN, ss_t_state_IN, t_rfr_IN, num_input_neurons_IN):
        ...
        return ['TAU_U_DENSE','W_DENSE','SS_T_STATE','TAU_V','V_THRSH','B','V','S','T_RFR','T_RFR_STATE','I_PH','ss_t_state_reset_scalar'], [TAU_U_DENSE,W_DENSE,SS_T_STATE,TAU_V,V_THRSH,B,V,S,T_RFR,T_RFR_STATE,I_PH,ss_t_state_reset_scalar]
    ...
    def initialize_spike_store(self, s_IN, input_duration_IN, record_nets_l_IN, num_neurons_in_single_network_IN):
        ...
        # condenses 3d mat into 2d mat with columns: (batch sample, ft, fn)
    ...
    # SLIM UPDATED
    def update_neuron_states_wo_R(self, v_IN, tau_v_IN, tau_u_dense_IN, b_IN, ss_t_state_IN, W_dense_IN, I_spikes_PH_IN, scatter_idx_W_dense_to_Neurons_IN,scatter_shp_IN,scatter_S_to_S_SUBSET_inputNeurons_IN,batch_by_num_input_neurons_l_IN,input_current_IN):
        ### FULLY UPDATED WITH 0 CAST [FLOAT32]: 1 SEC = 0.47

        # PARALLEL COMPATIBLE
        # COMPUTE CURRENT INPUT
        input_currents = tf.scalar_mul(input_current_IN,I_spikes_PH_IN)
