    ...
    def generate_validation_or_test_spike_data_STATIC(self
        ...
        for ITER in range(0, ITERATIONS):
            ...
            for bt in range(0, BATCH_SIZE_IN):
                ...
                valid_or_test_data_INPUT_VEC, valid_or_test_data_LABEL_VEC, valid_or_test_data_LABEL_SCALAR = self.run_sup.get_nmnist_data_point_with_NOISE(idx_IN=sample_idx,data_type_IN=str(data_type_IN),data_list_IN=valid_or_test_data_idx_l_IN,INPUT_DURATION_IN=SAMPLE_INPUT_DURATION_MS_IN,time_var_IN=TEMPORAL_NOISE_MAX_RANGE_IN)
