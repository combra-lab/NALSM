...
import sys
import time
import LSM_APSTDP_CONSTRUCTOR_N_MNIST_NOISE as construct
...
class run_sim:
    ...
    def train_loop_v0(self
        ...
        tst_spike_files_l, tst_s_agg_files_l = N1.generate_validation_or_test_spike_data_STATIC(sess_IN=sess
                                                                                         ...
                                                                                         , TEMPORAL_NOISE_MAX_RANGE_IN=NOISE_VAR_IN
                                                                                         )
...
if __name__ == "__main__":
    ...
    INTIAL_ABS_W_SCLR_VAR = float(1.0)
    ...
    TSL.train_loop_v0(SAVE_VER_IN=SAVE_VER_VAR
                        ...
                        , STDP_LTP_RANGE_IN=[STDP_NEURON_RATE_THESHOLD_VAR,
                                           STDP_NEURON_RATE_THESHOLD_VAR + STDP_NEURON_RATE_RANGE_VAR]
                        , STDP_LTD_RANGE_IN=[STDP_NEURON_RATE_THESHOLD_VAR - STDP_NEURON_RATE_RANGE_VAR,
                                           STDP_NEURON_RATE_THESHOLD_VAR]
