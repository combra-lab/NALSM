...
import NALSM_CONSTRUCTOR_MNIST as construct
...
class run_sim:
    ...
    def train_loop_v0(self
        ...
        N1_input_data_names, N1_input_data_data = run_sup.assemble_data_FMNIST(DATA_SEED_VAR_IN=DATASET_SEED_IN,num_train_val_test_l=N1_NUM_TRAIN_VAL_TEST_L_IN)
...
if __name__ == "__main__":
    ...
    N1_BATCH_SIZE_INP = input('N1_BATCH_SIZE? [int] (250 for smaller nets(1000 neurons)/ 50 for larger nets(8000 neurons): ')
    N1_BATCH_SIZE_VAR = int(N1_BATCH_SIZE_INP)

    N1_BATCHS_PER_BLOCK_INP = input('N1_BATCHS_PER_BLOCK? [int] (10 for smaller nets(1000 neurons)/ 50 for larger nets(8000 neurons): ')
    ...
    TSL.train_loop_v0(SAVE_VER_IN=SAVE_VER_VAR
                        ...
                        , ASTRO_W_SCALING_IN=ASTRO_W_SCALING_VAR
                        , ASTRO_TAU_IN=100.0
